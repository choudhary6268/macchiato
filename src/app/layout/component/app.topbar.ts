...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator, Dialog, ButtonModule, TextareaModule],
    template: ` <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            ...
            <p-dialog header="Acknowledge Validation Failures" [modal]="true" [(visible)]="modalVisible" [style]="{ width: '50rem' }">
                <span class="p-text-secondary block mb-8">Provide a comment to add an Acknowledgement to the selcted validation failures.</span>

                <div class="flex items-center gap-4 mb-4">
                    <label for="username" class="font-semibold w-24">Comment</label>
                </div>
                <textarea id="comment" rows="5" cols="88" pTextarea></textarea>
                <div class="flex justify-end gap-2 mt-8">
                    <p-button label="Cancel" severity="secondary" (click)="modalVisible = false" />
                    <p-button label="Acknowledge" (click)="modalVisible = false" />
                </div>
            </p-dialog>
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <button (click)="showDialog()" type="button" class="layout-topbar-action">
